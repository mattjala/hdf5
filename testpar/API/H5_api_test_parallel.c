...
char H5_api_test_parallel_filename[HD5_TEST_FILENAME_MAX_LENGTH];
...
main(int argc, char **argv)
{
    ...
    snprintf(H5_api_test_parallel_filename, HD5_TEST_FILENAME_MAX_LENGTH, "%s%s", test_path_prefix,
