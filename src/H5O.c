...
H5Oopen(hid_t loc_id, const char *name, hid_t lapl_id)
{
    ...
    FUNC_ENTER_API_NO_MUTEX(H5I_INVALID_HID, loc_id, lapl_id)
              ...
              hid_t lapl_id, hid_t es_id)
{
    ...
    FUNC_ENTER_API_NO_MUTEX(H5I_INVALID_HID, loc_id, lapl_id, es_id)
...
H5Oopen_by_token(hid_t loc_id, H5O_token_t token)
{
    ...
    FUNC_ENTER_API_NO_MUTEX(H5I_INVALID_HID, loc_id)
        ...
        hid_t lcpl_id)
{
    ...
    FUNC_ENTER_API_NO_MUTEX(FAIL, src_loc_id, dst_loc_id, ocpypl_id, lcpl_id)
    ...
    FUNC_LEAVE_API_NO_MUTEX(ret_value, src_loc_id, dst_loc_id, ocpypl_id, lcpl_id)
} /* end H5Ocopy() */
              ...
              hid_t es_id)
{
    ...
    FUNC_ENTER_API_NO_MUTEX(FAIL, src_loc_id, dst_loc_id, ocpypl_id, lcpl_id, es_id)
    ...
    FUNC_LEAVE_API_NO_MUTEX(ret_value, src_loc_id, dst_loc_id, ocpypl_id, lcpl_id, es_id)
} /* H5Ocopy_async() */
...
H5Orefresh(hid_t oid)
{
    ...
    FUNC_ENTER_API_NO_MUTEX(FAIL, oid)
    H5TRACE1("e", "i", oid);
    ...
    FUNC_LEAVE_API_NO_MUTEX(ret_value, oid)
} /* end H5Orefresh() */
...
H5Orefresh_async(const char *app_file, const char *app_func, unsigned app_line, hid_t oid, hid_t es_id)
{
    ...
    FUNC_ENTER_API_NO_MUTEX(FAIL, oid, es_id)
    ...
    FUNC_LEAVE_API_NO_MUTEX(ret_value, oid, es_id)
} /* H5Orefresh_async() */
...
H5Olink(hid_t obj_id, hid_t new_loc_id, const char *new_name, hid_t lcpl_id, hid_t lapl_id)
{
    ...
    FUNC_ENTER_API_NO_MUTEX(FAIL, obj_id, new_loc_id, lcpl_id, lapl_id)
...
/* Avoid compiler warning on 32-bit machines */
    ...
    FUNC_LEAVE_API_NO_MUTEX(ret_value, obj_id, new_loc_id, lcpl_id, lapl_id)
} /* end H5Olink() */
...
H5Oget_comment_by_name(hid_t loc_id, const char *name, char *comment /*out*/, size_t bufsize, hid_t lapl_id)
{
    ...
    FUNC_ENTER_API_NO_MUTEX(-1, loc_id, lapl_id)
