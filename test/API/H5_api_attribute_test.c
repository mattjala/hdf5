...
test_create_attribute_on_root(void)
{
    ...
    BEGIN_MULTIPART
    {
        ...
        {
            TESTING_2_API("H5Acreate on the root group");
        ...
        {
            TESTING_2_API("H5Acreate_by_name on the root group");
            ...
            if ((attr_id2 = H5Acreate_by_name(file_id, "/", ATTRIBUTE_CREATE_ON_ROOT_ATTR_NAME2, attr_dtype2,
                ...
                PART_ERROR_API(H5Acreate_by_name);
            }
    ...
    BEGIN_MULTIPART
    {
        PART_BEGIN(H5Acreate_on_dataset)
        {
            ...
            if ((attr_id = H5Acreate2(dset_id, ATTRIBUTE_CREATE_ON_DATASET_ATTR_NAME, attr_dtype1,
                ...
                PART_ERROR_API(H5Acreate_on_dataset);
            }
        ...
        PART_BEGIN(H5Acreate_by_name_on_dataset)
        {
            ...
            if ((attr_id2 = H5Acreate_by_name(group_id, ATTRIBUTE_CREATE_ON_DATASET_DSET_NAME,
                ...
                PART_ERROR_API(H5Acreate_by_name_on_dataset);
            }
...
test_create_attribute_on_datatype(void)
{
    ...
    BEGIN_MULTIPART
    {
        ...
        {
            TESTING_2_API("H5Acreate on a committed datatype");
            ...
            if ((attr_id = H5Acreate2(type_id, ATTRIBUTE_CREATE_ON_DATATYPE_ATTR_NAME, attr_dtype1, space_id,
                ...
                PART_ERROR_API(H5Acreate_on_datatype);
            }
        ...
        {
            TESTING_2_API("H5Acreate_by_name on a committed datatype");
            ...
            if ((attr_id2 = H5Acreate_by_name(group_id, ATTRIBUTE_CREATE_ON_DATATYPE_DTYPE_NAME,
                ...
                PART_ERROR_API(H5Acreate_by_name_on_datatype);
            }
...
test_create_attribute_with_null_space(void)
{
    ...
    TESTING_API("attribute creation with a NULL dataspace");
...
test_create_attribute_with_scalar_space(void)
{
    ...
    TESTING_API("attribute creation with a SCALAR dataspace");
...
test_create_attribute_with_space_in_name(void)
{
    ...
    TESTING_API("attribute creation with a space in attribute's name");
...
test_create_attribute_invalid_params(void)
{
    ...
    BEGIN_MULTIPART
    {
        ...
        {
            TESTING_2_API("H5Acreate with invalid loc_id");
            ...
            if (attr_id >= 0) {
                ...
                H5Aclose(attr_id);
                PART_ERROR_API(H5Acreate_invalid_loc_id);
            }
        ...
        {
            TESTING_2_API("H5Acreate with invalid attribute name");
            ...
            if (attr_id >= 0) {
                ...
                H5Aclose(attr_id);
                PART_ERROR_API(H5Acreate_invalid_attr_name);
            }
        ...
        {
            TESTING_2_API("H5Acreate with an invalid datatype");
            ...
            if (attr_id >= 0) {
                ...
                H5Aclose(attr_id);
                PART_ERROR_API(H5Acreate_invalid_datatype);
            }
        ...
        {
            TESTING_2_API("H5Acreate with an invalid dataspace");
            ...
            if (attr_id >= 0) {
                ...
                H5Aclose(attr_id);
                PART_ERROR_API(H5Acreate_invalid_dataspace);
            }
        ...
        {
            TESTING_2_API("H5Acreate with an invalid ACPL");
            ...
            if (attr_id >= 0) {
                ...
                H5Aclose(attr_id);
                PART_ERROR_API(H5Acreate_invalid_acpl);
            }
        ...
        {
            TESTING_2_API("H5Acreate with an invalid AAPL");
            ...
            if (attr_id >= 0) {
                ...
                H5Aclose(attr_id);
                PART_ERROR_API(H5Acreate_invalid_aapl);
            }
        ...
        {
            TESTING_2_API("H5Acreate_by_name with an invalid loc_id");
            ...
            if (attr_id >= 0) {
                ...
                H5Aclose(attr_id);
                PART_ERROR_API(H5Acreate_by_name_invalid_loc_id);
            }
        ...
        {
            TESTING_2_API("H5Acreate_by_name with invalid object name");
            ...
            if (attr_id >= 0) {
                ...
                H5Aclose(attr_id);
                PART_ERROR_API(H5Acreate_by_name_invalid_obj_name);
            }
        ...
        {
            TESTING_2_API("H5Acreate_by_name with invalid attribute name");
            ...
            if (attr_id >= 0) {
                ...
                H5Aclose(attr_id);
                PART_ERROR_API(H5Acreate_by_name_invalid_attr_name);
            }
        ...
        {
            TESTING_2_API("H5Acreate_by_name with invalid datatype");
            ...
            if (attr_id >= 0) {
                ...
                H5Aclose(attr_id);
                PART_ERROR_API(H5Acreate_by_name_invalid_datatype);
            }
        ...
        {
            TESTING_2_API("H5Acreate_by_name with invalid dataspace");
            ...
            if (attr_id >= 0) {
                ...
                H5Aclose(attr_id);
                PART_ERROR_API(H5Acreate_by_name_invalid_dataspace);
            }
        ...
        {
            TESTING_2_API("H5Acreate_by_name with invalid ACPL");
            ...
            if (attr_id >= 0) {
                ...
                H5Aclose(attr_id);
                PART_ERROR_API(H5Acreate_by_name_invalid_acpl);
            }
        ...
        {
            TESTING_2_API("H5Acreate_by_name with invalid AAPL");
            ...
            if (attr_id >= 0) {
                ...
                H5Aclose(attr_id);
                PART_ERROR_API(H5Acreate_by_name_invalid_aapl);
            }
        ...
        {
            TESTING_2_API("H5Acreate_by_name with invalid LAPL");
            ...
            if (attr_id >= 0) {
                ...
                H5Aclose(attr_id);
                PART_ERROR_API(H5Acreate_by_name_invalid_lapl);
            }
...
test_open_attribute(void)
{
    ...
    BEGIN_MULTIPART
    {
        ...
        {
            TESTING_2_API("H5Aopen_by_idx by creation order in increasing order");
            ...
            if ((attr_id = H5Aopen_by_idx(container_group, ATTRIBUTE_OPEN_TEST_GROUP_NAME, H5_INDEX_CRT_ORDER,
                ...
                PART_ERROR_API(H5Aopen_by_idx_crt_order_increasing);
            }
        ...
        {
            TESTING_2_API("H5Aopen_by_idx by creation order in decreasing order");
            ...
            if ((attr_id = H5Aopen_by_idx(container_group, ATTRIBUTE_OPEN_TEST_GROUP_NAME, H5_INDEX_CRT_ORDER,
                ...
                PART_ERROR_API(H5Aopen_by_idx_crt_order_decreasing);
            }
        ...
        {
            TESTING_2_API("H5Aopen_by_idx by alphabetical order in increasing order");
        ...
        {
            TESTING_2_API("H5Aopen_by_idx by alphabetical order in decreasing order");
            ...
            if ((attr_id = H5Aopen_by_idx(container_group, ATTRIBUTE_OPEN_TEST_GROUP_NAME, H5_INDEX_NAME,
                ...
                printf("    couldn't open attribute '%s' at index %d using H5Aopen_by_idx by "
                       ...
                       ATTRIBUTE_OPEN_TEST_ATTR_NAME, 2);
                PART_ERROR_API(H5Aopen_by_idx_name_order_decreasing);
            }
...
test_open_attribute_invalid_params(void)
{
    ...
    BEGIN_MULTIPART
    {
        ...
        {
            TESTING_2_API("H5Aopen with an invalid loc_id");
            ...
            if (attr_id >= 0) {
                ...
                printf("    opened attribute '%s' using H5Aopen with an invalid loc_id!\n",
                       ATTRIBUTE_OPEN_INVALID_PARAMS_TEST_ATTR_NAME);
                H5Aclose(attr_id);
                PART_ERROR_API(H5Aopen_invalid_loc_id);
            }
        ...
        {
            TESTING_2_API("H5Aopen with an invalid attribute name");
            ...
            if (attr_id >= 0) {
                ...
                printf("    opened attribute '%s' using H5Aopen with a NULL attribute name!\n",
                       ATTRIBUTE_OPEN_INVALID_PARAMS_TEST_ATTR_NAME);
                H5Aclose(attr_id);
                PART_ERROR_API(H5Aopen_invalid_attr_name);
            }
        ...
        {
            TESTING_2_API("H5Aopen with an invalid AAPL");
            ...
            if (attr_id >= 0) {
                ...
                printf("    opened attribute '%s' using H5Aopen with an invalid AAPL!\n",
                       ATTRIBUTE_OPEN_INVALID_PARAMS_TEST_ATTR_NAME);
                H5Aclose(attr_id);
                PART_ERROR_API(H5Aopen_invalid_aapl);
            }
        ...
        {
            TESTING_2_API("H5Aopen_by_name with an invalid loc_id");
            ...
            if (attr_id >= 0) {
                ...
                printf("    opened attribute '%s' using H5Aopen_by_name with an invalid loc_id!\n",
                       ATTRIBUTE_OPEN_INVALID_PARAMS_TEST_ATTR_NAME);
                H5Aclose(attr_id);
                PART_ERROR_API(H5Aopen_by_name_invalid_loc_id);
            }
        ...
        {
            TESTING_2_API("H5Aopen_by_name with an invalid object name");
            ...
            if (attr_id >= 0) {
                ...
                printf("    opened attribute '%s' using H5Aopen_by_name with a NULL object name!\n",
                       ATTRIBUTE_OPEN_INVALID_PARAMS_TEST_ATTR_NAME);
                H5Aclose(attr_id);
                PART_ERROR_API(H5Aopen_by_name_invalid_obj_name);
            }
        ...
        {
            TESTING_2_API("H5Aopen_by_name with an invalid attribute name");
            ...
            if (attr_id >= 0) {
                ...
                printf("    opened attribute '%s' using H5Aopen_by_name with a NULL attribute name!\n",
                       ATTRIBUTE_OPEN_INVALID_PARAMS_TEST_ATTR_NAME);
                H5Aclose(attr_id);
                PART_ERROR_API(H5Aopen_by_name_invalid_attr_name);
            }
        ...
        {
            TESTING_2_API("H5Aopen_by_name with an invalid AAPL");
            ...
            if (attr_id >= 0) {
                ...
                printf("    opened attribute '%s' using H5Aopen_by_name with an invalid AAPL!\n",
                       ATTRIBUTE_OPEN_INVALID_PARAMS_TEST_ATTR_NAME);
                H5Aclose(attr_id);
                PART_ERROR_API(H5Aopen_by_name_invalid_aapl);
            }
        ...
        {
            TESTING_2_API("H5Aopen_by_name with an invalid LAPL");
            ...
            if (attr_id >= 0) {
                ...
                printf("    opened attribute '%s' using H5Aopen_by_name with an invalid LAPL!\n",
                       ATTRIBUTE_OPEN_INVALID_PARAMS_TEST_ATTR_NAME);
                H5Aclose(attr_id);
                PART_ERROR_API(H5Aopen_by_name_invalid_lapl);
            }
        ...
        {
            TESTING_2_API("H5Aopen_by_idx with an invalid loc_id");
            ...
            if (attr_id >= 0) {
                ...
                printf("    opened attribute '%s' using H5Aopen_by_idx with an invalid loc_id!\n",
                       ATTRIBUTE_OPEN_INVALID_PARAMS_TEST_ATTR_NAME);
                H5Aclose(attr_id);
                PART_ERROR_API(H5Aopen_by_idx_invalid_loc_id);
            }
        ...
        {
            TESTING_2_API("H5Aopen_by_idx with an invalid object name");
            ...
            if (attr_id >= 0) {
                ...
                printf("    opened attribute '%s' using H5Aopen_by_idx with a NULL object name!\n",
                       ATTRIBUTE_OPEN_INVALID_PARAMS_TEST_ATTR_NAME);
                H5Aclose(attr_id);
                PART_ERROR_API(H5Aopen_by_idx_invalid_obj_name);
            }
        ...
        {
            TESTING_2_API("H5Aopen_by_idx with an invalid index type");
            ...
            if (attr_id >= 0) {
                ...
                printf("    opened attribute '%s' using H5Aopen_by_idx with invalid index type "
                       ...
                       ATTRIBUTE_OPEN_INVALID_PARAMS_TEST_ATTR_NAME);
                H5Aclose(attr_id);
                PART_ERROR_API(H5Aopen_by_idx_invalid_index_type);
            }
        ...
        {
            TESTING_2_API("H5Aopen_by_idx with an invalid iteration order");
            ...
            if (attr_id >= 0) {
                ...
                printf("    opened attribute '%s' using H5Aopen_by_idx with invalid iteration order "
                       ...
                       ATTRIBUTE_OPEN_INVALID_PARAMS_TEST_ATTR_NAME);
                H5Aclose(attr_id);
                PART_ERROR_API(H5Aopen_by_idx_invalid_iter_order);
            }
        ...
        {
            TESTING_2_API("H5Aopen_by_idx with an invalid AAPL");
            ...
            if (attr_id >= 0) {
                ...
                printf("    opened attribute '%s' using H5Aopen_by_idx with an invalid AAPL!\n",
                       ATTRIBUTE_OPEN_INVALID_PARAMS_TEST_ATTR_NAME);
                H5Aclose(attr_id);
                PART_ERROR_API(H5Aopen_by_idx_invalid_aapl);
            }
        ...
        {
            TESTING_2_API("H5Aopen_by_idx with an invalid LAPL");
            ...
            if (attr_id >= 0) {
                ...
                printf("    opened attribute '%s' using H5Aopen_by_idx with an invalid LAPL!\n",
                       ATTRIBUTE_OPEN_INVALID_PARAMS_TEST_ATTR_NAME);
                H5Aclose(attr_id);
                PART_ERROR_API(H5Aopen_by_idx_invalid_lapl);
            }
...
test_write_attribute_invalid_params(void)
{
    ...
    BEGIN_MULTIPART
    {
        ...
        {
            TESTING_2_API("H5Awrite with an invalid attr_id");
            ...
            if (err_ret >= 0) {
                ...
                PART_ERROR_API(H5Awrite_invalid_attr_id);
            }
        ...
        {
            TESTING_2_API("H5Awrite with an invalid datatype");
            ...
            if (err_ret >= 0) {
                ...
                PART_ERROR_API(H5Awrite_invalid_datatype);
            }
        ...
        {
            TESTING_2_API("H5Awrite with an invalid data buffer");
            ...
            if (err_ret >= 0) {
                ...
                PART_ERROR_API(H5Awrite_invalid_data_buf);
            }
...
test_read_attribute_invalid_params(void)
{
    ...
    BEGIN_MULTIPART
    {
        ...
        {
            TESTING_2_API("H5Aread with an invalid attr_id");
            ...
            if (err_ret >= 0) {
                ...
                PART_ERROR_API(H5Aread_invalid_attr_id);
            }
        ...
        {
            TESTING_2_API("H5Aread with an invalid datatype");
        ...
        {
            TESTING_2_API("H5Aread with an invalid read buffer");
            ...
            if (err_ret >= 0) {
                ...
                PART_ERROR_API(H5Aread_invalid_read_buf);
            }
...
test_read_empty_attribute(void)
{
    ...
    TESTING_API("reading an empty attribute");
...
test_close_attribute_invalid_id(void)
{
    ...
    TESTING_API("H5Aclose with an invalid attribute ID");
...
test_get_attribute_space_and_type(void)
{
    ...
    BEGIN_MULTIPART
    {
        ...
        {
            TESTING_2_API("H5Aget_type after re-opening an attribute");
            ...
            if ((attr_id = H5Aopen(group_id, ATTRIBUTE_GET_SPACE_TYPE_TEST_ATTR_NAME, H5P_DEFAULT)) < 0) {
                ...
                PART_ERROR_API(H5Aget_type_reopened);
            }
        ...
        {
            TESTING_2_API("H5Aget_space after re-opening an attribute");

            if ((attr_id = H5Aopen(group_id, ATTRIBUTE_GET_SPACE_TYPE_TEST_ATTR_NAME, H5P_DEFAULT)) < 0) {
                H5_FAILED_API();
                printf("    couldn't open attribute '%s'\n", ATTRIBUTE_GET_SPACE_TYPE_TEST_ATTR_NAME);
                PART_ERROR_API(H5Aget_space_reopened);
            }
...
test_get_attribute_space_and_type_invalid_params(void)
{
    ...
    BEGIN_MULTIPART
    {
        ...
        {
            TESTING_2_API("H5Aget_type with an invalid attr_id");
            ...
            if (tmp_type_id >= 0) {
                ...
                PART_ERROR_API(H5Aget_type_invalid_attr_id);
            }
        ...
        {
            TESTING_2_API("H5Aget_space with an invalid attr_id");
...
test_attribute_property_lists(void)
{
    ...
    BEGIN_MULTIPART
    {
        ...
        {
            TESTING_2_API("H5Aget_create_plist");
            ...
            if ((acpl_id1 = H5Aget_create_plist(attr_id1)) < 0) {
                ...
                PART_ERROR_API(H5Aget_create_plist);
            }
        ...
        {
            TESTING_2_API("H5Aget_create_plist after re-opening an attribute");
            ...
            if ((attr_id1 = H5Aopen(group_id, ATTRIBUTE_PROPERTY_LIST_TEST_ATTRIBUTE_NAME1, H5P_DEFAULT)) <
                ...
                PART_ERROR_API(H5Aget_create_plist_reopened);
            }
...
test_get_attribute_name(void)
{
    ...
    BEGIN_MULTIPART
    {
        ...
        {
            TESTING_2_API("H5Aget_name_by_idx by creation order in increasing order");
            ...
            *name_buf = '\0';
            if (H5Aget_name_by_idx(container_group, ATTRIBUTE_GET_NAME_TEST_GROUP_NAME, H5_INDEX_CRT_ORDER,
                ...
                printf("    couldn't retrieve name of attribute at index %d using H5Aget_name_by_index by "
                       ...
                       0);
                PART_ERROR_API(H5Aget_name_by_idx_crt_order_increasing);
            }
        ...
        {
            TESTING_2_API("H5Aget_name_by_idx by creation order in decreasing order");
            ...
            *name_buf = '\0';
            if (H5Aget_name_by_idx(container_group, ATTRIBUTE_GET_NAME_TEST_GROUP_NAME, H5_INDEX_CRT_ORDER,
                ...
                printf("    couldn't retrieve name of attribute at index %d using H5Aget_name_by_index by "
                       ...
                       2);
                PART_ERROR_API(H5Aget_name_by_idx_crt_order_decreasing);
            }
        ...
        {
            TESTING_2_API("H5Aget_name_by_idx by alphabetical order in increasing order");
            ...
            *name_buf = '\0';
            if (H5Aget_name_by_idx(container_group, ATTRIBUTE_GET_NAME_TEST_GROUP_NAME, H5_INDEX_NAME,
                ...
                printf("    couldn't retrieve name of attribute at index %d using H5Aget_name_by_index by "
                       ...
                       0);
                PART_ERROR_API(H5Aget_name_by_idx_name_order_increasing);
            }
        ...
        {
            TESTING_2_API("H5Aget_name_by_idx by alphabetical order in decreasing order");
            ...
            *name_buf = '\0';
            if (H5Aget_name_by_idx(container_group, ATTRIBUTE_GET_NAME_TEST_GROUP_NAME, H5_INDEX_NAME,
                ...
                printf("    couldn't retrieve name of attribute at index %d using H5Aget_name_by_index "
                       ...
                       2);
                PART_ERROR_API(H5Aget_name_by_idx_name_order_decreasing);
            }
...
test_get_attribute_name_invalid_params(void)
{
    ...
    BEGIN_MULTIPART
    {
        ...
        {
            TESTING_2_API("H5Aget_name with an invalid attr_id");
        ...
        {
            TESTING_2_API("H5Aget_name with an invalid name buffer");
            ...
            if (name_buf_size >= 0) {
                ...
                PART_ERROR_API(H5Aget_name_invalid_name_buf);
            }
        ...
        {
            TESTING_2_API("H5Aget_name_by_idx with an invalid loc_id");
            ...
            if (name_buf_size >= 0) {
                ...
                PART_ERROR_API(H5Aget_name_by_idx_invalid_loc_id);
            }
        ...
        {
            TESTING_2_API("H5Aget_name_by_idx with an invalid object name");
            ...
            if (name_buf_size >= 0) {
                ...
                PART_ERROR_API(H5Aget_name_by_idx_invalid_obj_name);
            }
        ...
        {
            TESTING_2_API("H5Aget_name_by_idx with an invalid index type");
        ...
        {
            TESTING_2_API("H5Aget_name_by_idx with an invalid iteration order");
            ...
            if (name_buf_size >= 0) {
                ...
                printf("    retrieved attribute name using H5Aget_name_by_idx with invalid iteration order "
                       "H5_ITER_UNKNOWN!\n");
                PART_ERROR_API(H5Aget_name_by_idx_invalid_iter_order);
            }
        ...
        {
            TESTING_2_API("H5Aget_name_by_idx with an invalid name buffer");
        ...
        {
            TESTING_2_API("H5Aget_name_by_idx with an invalid LAPL");
            ...
            if (name_buf_size >= 0) {
                ...
                PART_ERROR_API(H5Aget_name_by_idx_invalid_lapl);
            }
...
{
    TESTING_API("H5Aget_storage_size");
...
test_get_attribute_info(void)
{
    ...
    BEGIN_MULTIPART
    {
        ...
        {
            TESTING_2_API("H5Aget_info_by_name");
        ...
        {
            TESTING_2_API("H5Aget_info_by_idx by creation order in increasing order");
            ...
            if (H5Aget_info_by_idx(group_id, ".", H5_INDEX_CRT_ORDER, H5_ITER_INC, 0, &attr_info,
                ...
                printf("    couldn't get info for attribute at index %d using H5Aget_info_by_idx by "
                       "creation order in increasing order\n",
                       0);
                PART_ERROR_API(H5Aget_info_by_idx_crt_order_increasing);
            }
        ...
        {
            TESTING_2_API("H5Aget_info_by_idx by creation order in decreasing order");
            ...
            if (H5Aget_info_by_idx(group_id, ".", H5_INDEX_CRT_ORDER, H5_ITER_DEC, 2, &attr_info,
                ...
                printf("    couldn't get info for attribute at index %d using H5Aget_info_by_idx by "
                       "creation order in decreasing order\n",
                       2);
                PART_ERROR_API(H5Aget_info_by_idx_crt_order_decreasing);
            }
        ...
        {
            TESTING_2_API("H5Aget_info_by_idx by alphabetical order in increasing order");
            ...
            if (H5Aget_info_by_idx(group_id, ".", H5_INDEX_NAME, H5_ITER_INC, 0, &attr_info, H5P_DEFAULT) <
                ...
                printf("    couldn't get info for attribute at index %d using H5Aget_info_by_idx by "
                       "alphabetical order in increasing order\n",
                       0);
                PART_ERROR_API(H5Aget_info_by_idx_name_order_increasing);
            }
        ...
        {
            TESTING_2_API("H5Aget_info_by_idx by alphabetical order in decreasing order");
            ...
            if (H5Aget_info_by_idx(group_id, ".", H5_INDEX_NAME, H5_ITER_DEC, 2, &attr_info, H5P_DEFAULT) <
                ...
                printf("    couldn't get info for attribute at index %d using H5Aget_info_by_idx by "
                       "alphabetical order in decreasing order\n",
                       2);
                PART_ERROR_API(H5Aget_info_by_idx_name_order_decreasing);
            }
...
test_get_attribute_info_invalid_params(void)
{
    ...
    BEGIN_MULTIPART
    {
        ...
        {
            TESTING_2_API("H5Aget_info with an invalid attr_id");
            ...
            if (err_ret >= 0) {
                ...
                PART_ERROR_API(H5Aget_info_invalid_attr_id);
            }
        ...
        {
            TESTING_2_API("H5Aget_info with an invalid attribute info pointer");
        ...
        {
            TESTING_2_API("H5Aget_info_by_name with an invalid loc_id");
            ...
            if (err_ret >= 0) {
                ...
                PART_ERROR_API(H5Aget_info_by_name_invalid_loc_id);
            }
        ...
        {
            TESTING_2_API("H5Aget_info_by_name with an invalid object name");
            ...
            if (err_ret >= 0) {
                ...
                PART_ERROR_API(H5Aget_info_by_name_invalid_obj_name);
            }
        ...
        {
            TESTING_2_API("H5Aget_info_by_name with an invalid attribute name");
            ...
            if (err_ret >= 0) {
                ...
                PART_ERROR_API(H5Aget_info_by_name_invalid_attr_name);
            }
        ...
        {
            TESTING_2_API("H5Aget_info_by_name with an invalid attribute info pointer");
            ...
            if (err_ret >= 0) {
                ...
                printf("    retrieved attribute info using H5Aget_info_by_name with an invalid attribute "
                       "info pointer!\n");
                PART_ERROR_API(H5Aget_info_by_name_invalid_attr_info_pointer);
            }
        ...
        {
            TESTING_2_API("H5Aget_info_by_name with an invalid LAPL");
            ...
            if (err_ret >= 0) {
                ...
                PART_ERROR_API(H5Aget_info_by_name_invalid_lapl);
            }
        ...
        {
            TESTING_2_API("H5Aget_info_by_idx with an invalid loc_id");
        ...
        {
            TESTING_2_API("H5Aget_info_by_idx with an invalid object name");
            ...
            if (err_ret >= 0) {
                ...
                PART_ERROR_API(H5Aget_info_by_idx_invalid_obj_name);
            }
        ...
        {
            TESTING_2_API("H5Aget_info_by_idx with an invalid index type");
        ...
        {
            TESTING_2_API("H5Aget_info_by_idx with an invalid iteration order");
        ...
        {
            TESTING_2_API("H5Aget_info_by_idx with an invalid attribute info pointer");
            ...
            if (err_ret >= 0) {
                ...
                printf("    retrieved attribute info using H5Aget_info_by_idx with an invalid attribute "
                       "info pointer!\n");
                PART_ERROR_API(H5Aget_info_by_idx_invalid_attr_info_pointer);
            }
        ...
        {
            TESTING_2_API("H5Aget_info_by_idx with an invalid LAPL");
            ...
            if (err_ret >= 0) {
                ...
                PART_ERROR_API(H5Aget_info_by_idx_invalid_lapl);
            }
...
test_rename_attribute(void)
{
    ...
    BEGIN_MULTIPART
    {
        ...
        {
            TESTING_2_API("H5Arename_by_name");
            ...
            if (H5Arename_by_name(container_group, ATTRIBUTE_RENAME_TEST_GROUP_NAME,
                ...
                printf("    couldn't rename attribute '%s' to '%s' using H5Arename_by_name\n",
                       ATTRIBUTE_RENAME_TEST_ATTR_NAME2, ATTRIBUTE_RENAME_TEST_NEW_NAME2);
                PART_ERROR_API(H5Arename_by_name);
            }
...
test_rename_attribute_invalid_params(void)
{
    ...
    BEGIN_MULTIPART
    {
        ...
        {
            TESTING_2_API("H5Arename with an invalid loc_id");
            ...
            if (err_ret >= 0) {
                ...
                PART_ERROR_API(H5Arename_invalid_loc_id);
            }
        ...
        {
            TESTING_2_API("H5Arename with an invalid old attribute name");
            ...
            if (err_ret >= 0) {
                ...
                PART_ERROR_API(H5Arename_invalid_old_attr_name);
            }
        ...
        {
            TESTING_2_API("H5Arename with an invalid new attribute name");
            ...
            if (err_ret >= 0) {
                ...
                PART_ERROR_API(H5Arename_invalid_new_attr_name);
            }
        ...
        {
            TESTING_2_API("H5Arename_by_name with an invalid loc_id");
            ...
            if (err_ret >= 0) {
                ...
                PART_ERROR_API(H5Arename_by_name_invalid_loc_id);
            }
        ...
        {
            TESTING_2_API("H5Arename_by_name with an invalid object name");
            ...
            if (err_ret >= 0) {
                ...
                PART_ERROR_API(H5Arename_by_name_invalid_obj_name);
            }
        ...
        {
            TESTING_2_API("H5Arename_by_name with an invalid old attribute name");
            ...
            if (err_ret >= 0) {
                ...
                PART_ERROR_API(H5Arename_by_name_invalid_old_attr_name);
            }
        ...
        {
            TESTING_2_API("H5Arename_by_name with an invalid new attribute name");
            ...
            if (err_ret >= 0) {
                ...
                PART_ERROR_API(H5Arename_by_name_invalid_new_attr_name);
            }
        ...
        {
            TESTING_2_API("H5Arename_by_name with an invalid LAPL");
            ...
            if (err_ret >= 0) {
                ...
                PART_ERROR_API(H5Arename_by_name_invalid_lapl);
            }
...
test_attribute_iterate_group(void)
{
    ...
    BEGIN_MULTIPART
    {
        ...
        {
            TESTING_2_API("H5Aiterate by attribute name in increasing order");
            ...
            if (H5Aiterate2(group_id, H5_INDEX_NAME, H5_ITER_INC, NULL, attr_iter_callback1, &link_counter) <
                ...
                PART_ERROR_API(H5Aiterate2_name_increasing);
            }
        ...
        {
            TESTING_2_API("H5Aiterate by attribute name in decreasing order");
            ...
            if (H5Aiterate2(group_id, H5_INDEX_NAME, H5_ITER_DEC, NULL, attr_iter_callback1, &link_counter) <
                ...
                PART_ERROR_API(H5Aiterate2_name_decreasing);
            }
        ...
        {
            TESTING_2_API("H5Aiterate by creation order in increasing order");
            ...
            if (H5Aiterate2(group_id, H5_INDEX_CRT_ORDER, H5_ITER_INC, NULL, attr_iter_callback1,
                ...
                PART_ERROR_API(H5Aiterate2_creation_increasing);
            }
        ...
        {
            TESTING_2_API("H5Aiterate by creation order in decreasing order");
            ...
            if (H5Aiterate2(group_id, H5_INDEX_CRT_ORDER, H5_ITER_DEC, NULL, attr_iter_callback1,
                ...
                PART_ERROR_API(H5Aiterate2_creation_decreasing);
            }
        ...
        {
            TESTING_2_API("H5Aiterate_by_name by attribute name in increasing order");
            ...
            if (H5Aiterate_by_name(
                ...
                PART_ERROR_API(H5Aiterate_by_name_name_increasing);
            }
        ...
        {
            TESTING_2_API("H5Aiterate_by_name by attribute name in decreasing order");
            ...
            if (H5Aiterate_by_name(
                ...
                PART_ERROR_API(H5Aiterate_by_name_name_decreasing);
            }
        ...
        {
            TESTING_2_API("H5Aiterate_by_name by creation order in increasing order");
            ...
            if (H5Aiterate_by_name(file_id,
                ...
                PART_ERROR_API(H5Aiterate_by_name_creation_increasing);
            }
        ...
        {
            TESTING_2_API("H5Aiterate_by_name by creation order in decreasing order");
            ...
            if (H5Aiterate_by_name(file_id,
                ...
                PART_ERROR_API(H5Aiterate_by_name_creation_decreasing);
            }
...
{
    TESTING_API("attribute iteration index saving capability");
...
test_attribute_iterate_invalid_params(void)
{
    ...
    BEGIN_MULTIPART
    {
        ...
        {
            TESTING_2_API("H5Aiterate with an invalid loc_id");
            ...
            if (err_ret >= 0) {
                ...
                PART_ERROR_API(H5Aiterate_invalid_loc_id);
            }
        ...
        {
            TESTING_2_API("H5Aiterate with an invalid index type");
            ...
            if (err_ret >= 0) {
                ...
                printf("    iterated over attributes using H5Aiterate with invalid index type "
                       "H5_INDEX_UNKNOWN!\n");
                PART_ERROR_API(H5Aiterate_invalid_index_type);
            }
        ...
        {
            TESTING_2_API("H5Aiterate with an invalid index ordering");
        ...
        {
            TESTING_2_API("H5Aiterate_by_name with an invalid loc_id");
            ...
            if (err_ret >= 0) {
                ...
                PART_ERROR_API(H5Aiterate_by_name_invalid_loc_id);
            }
        ...
        {
            TESTING_2_API("H5Aiterate_by_name with an invalid object name");
            ...
            if (err_ret >= 0) {
                ...
                PART_ERROR_API(H5Aiterate_by_name_invalid_obj_name);
            }
        ...
        {
            TESTING_2_API("H5Aiterate_by_name with an invalid index type");
            ...
            if (err_ret >= 0) {
                ...
                printf("    iterated over attributes using H5Aiterate_by_name with invalid index type "
                       "H5_INDEX_UNKNOWN!\n");
                PART_ERROR_API(H5Aiterate_by_name_invalid_index_type);
            }
        ...
        {
            TESTING_2_API("H5Aiterate_by_name with an invalid index ordering");
            ...
            if (err_ret >= 0) {
                ...
                printf("    iterated over attributes using H5Aiterate_by_name with invalid index ordering "
                       "H5_ITER_UNKNOWN!\n");
                PART_ERROR_API(H5Aiterate_by_name_invalid_index_order);
            }
        ...
        {
            TESTING_2_API("H5Aiterate_by_name with an invalid LAPL");
            ...
            if (err_ret >= 0) {
                ...
                PART_ERROR_API(H5Aiterate_by_name_invalid_lapl);
            }
...
test_attribute_iterate_0_attributes(void)
{
    ...
    BEGIN_MULTIPART
    {
        ...
        {
            TESTING_2_API("H5Aiterate (native order)");
            ...
            if (H5Aiterate2(dset_id, H5_INDEX_NAME, H5_ITER_NATIVE, NULL, attr_iter_callback2, NULL) < 0) {
                ...
                PART_ERROR_API(H5Aiterate_0_attributes_native);
            }
        ...
        {
            TESTING_2_API("H5Aiterate (increasing order)");

            if (H5Aiterate2(dset_id, H5_INDEX_NAME, H5_ITER_INC, NULL, attr_iter_callback2, NULL) < 0) {
                H5_FAILED_API();
                printf("    H5Aiterate2 on object with 0 attributes failed\n");
                PART_ERROR_API(H5Aiterate_0_attributes_inc);
            }
        ...
        {
            TESTING_2_API("H5Aiterate (decreasing order)");

            if (H5Aiterate2(dset_id, H5_INDEX_NAME, H5_ITER_DEC, NULL, attr_iter_callback2, NULL) < 0) {
                H5_FAILED_API();
                printf("    H5Aiterate2 on object with 0 attributes failed\n");
                PART_ERROR_API(H5Aiterate_0_attributes_dec);
            }
        ...
        {
            TESTING_2_API("H5Aiterate_by_name (native order)");
            ...
            if (H5Aiterate_by_name(group_id, ATTRIBUTE_ITERATE_TEST_0_ATTRIBUTES_DSET_NAME, H5_INDEX_NAME,
                ...
                PART_ERROR_API(H5Aiterate_by_name_0_attributes_native);
            }
        ...
        {
            TESTING_2_API("H5Aiterate_by_name (increasing order)");

            if (H5Aiterate_by_name(group_id, ATTRIBUTE_ITERATE_TEST_0_ATTRIBUTES_DSET_NAME, H5_INDEX_NAME,
                                   H5_ITER_INC, NULL, attr_iter_callback2, NULL, H5P_DEFAULT) < 0) {
                H5_FAILED_API();
                printf("    H5Aiterate_by_name on object with 0 attributes failed\n");
                PART_ERROR_API(H5Aiterate_by_name_0_attributes_inc);
            }
        ...
        {
            TESTING_2_API("H5Aiterate_by_name (decreasing order)");
            if (H5Aiterate_by_name(group_id, ATTRIBUTE_ITERATE_TEST_0_ATTRIBUTES_DSET_NAME, H5_INDEX_NAME,
                                   H5_ITER_DEC, NULL, attr_iter_callback2, NULL, H5P_DEFAULT) < 0) {
                H5_FAILED_API();
                printf("    H5Aiterate_by_name on object with 0 attributes failed\n");
                PART_ERROR_API(H5Aiterate_by_name_0_attributes_dec);
            }
...
test_delete_attribute(void)
{
    ...
    BEGIN_MULTIPART
    {
        ...
        {
            TESTING_2_API("H5Adelete_by_name");
            ...
            if ((attr_id = H5Acreate2(group_id, ATTRIBUTE_DELETION_TEST_ATTR_NAME, attr_dtype, space_id,
                ...
                H5_FAILED_API();
                printf("    couldn't create attribute '%s'\n", ATTRIBUTE_DELETION_TEST_ATTR_NAME);
                PART_ERROR_API(H5Adelete_by_name);
            }
        ...
        {
            TESTING_2_API("H5Adelete_by_idx by creation order in increasing order");
        ...
        {
            TESTING_2_API("H5Adelete_by_idx by creation order in decreasing order");
        ...
        {
            TESTING_2_API("H5Adelete_by_idx by alphabetical order in increasing order");
            ...
            if ((attr_id = H5Acreate2(group_id, ATTRIBUTE_DELETION_TEST_ATTR_NAME, attr_dtype, space_id,
                ...
                H5_FAILED_API();
                printf("    couldn't create attribute '%s'\n", ATTRIBUTE_DELETION_TEST_ATTR_NAME);
                PART_ERROR_API(H5Adelete_by_idx_name_order_increasing);
            }
        ...
        {
            TESTING_2_API("H5Adelete_by_idx by alphabetical order in decreasing order");
            ...
            if ((attr_id = H5Acreate2(group_id, ATTRIBUTE_DELETION_TEST_ATTR_NAME, attr_dtype, space_id,
                ...
                H5_FAILED_API();
                printf("    couldn't create attribute '%s'\n", ATTRIBUTE_DELETION_TEST_ATTR_NAME);
                PART_ERROR_API(H5Adelete_by_idx_name_order_decreasing);
            }
...
test_delete_attribute_invalid_params(void)
{
    ...
    BEGIN_MULTIPART
    {
        ...
        {
            TESTING_2_API("H5Adelete with an invalid loc_id");
            ...
            if (err_ret >= 0) {
                ...
                PART_ERROR_API(H5Adelete_invalid_loc_id);
            }
        ...
        {
            TESTING_2_API("H5Adelete with an invalid attribute name");
            ...
            if (err_ret >= 0) {
                ...
                PART_ERROR_API(H5Adelete_invalid_attr_name);
            }
        ...
        {
            TESTING_2_API("H5Adelete_by_name with an invalid loc_id");
            ...
            if (err_ret >= 0) {
                ...
                PART_ERROR_API(H5Adelete_by_name_invalid_loc_id);
            }
        ...
        {
            TESTING_2_API("H5Adelete_by_name with an invalid object name");
            ...
            if (err_ret >= 0) {
                ...
                PART_ERROR_API(H5Adelete_by_name_invalid_obj_name);
            }
        ...
        {
            TESTING_2_API("H5Adelete_by_name with an invalid attribute name");
            ...
            if (err_ret >= 0) {
                ...
                PART_ERROR_API(H5Adelete_by_name_invalid_attr_name);
            }
        ...
        {
            TESTING_2_API("H5Adelete_by_name with an invalid LAPL");
        ...
        {
            TESTING_2_API("H5Adelete_by_idx with an invalid loc_id");
            ...
            if (err_ret >= 0) {
                ...
                PART_ERROR_API(H5Adelete_by_idx_invalid_loc_id);
            }
        ...
        {
            TESTING_2_API("H5Adelete_by_idx with an invalid object name");
            ...
            if (err_ret >= 0) {
                ...
                PART_ERROR_API(H5Adelete_by_idx_invalid_obj_name);
            }
        ...
        {
            TESTING_2_API("H5Adelete_by_idx with an invalid index type");
            ...
            if (err_ret >= 0) {
                ...
                printf("    deleted an attribute using H5Adelete_by_idx with invalid index type "
                       "H5_INDEX_UNKNOWN!\n");
                PART_ERROR_API(H5Adelete_by_idx_invalid_index_type);
            }
        ...
        {
            TESTING_2_API("H5Adelete_by_idx with an invalid index ordering");
            ...
            if (err_ret >= 0) {
                ...
                printf("    deleted an attribute using H5Adelete_by_idx with invalid index ordering "
                       "H5_ITER_UNKNOWN!\n");
                PART_ERROR_API(H5Adelete_by_idx_invalid_index_order);
            }
        ...
        {
            TESTING_2_API("H5Adelete_by_idx with an invalid LAPL");
            ...
            if (err_ret >= 0) {
                ...
                PART_ERROR_API(H5Adelete_by_idx_invalid_lapl);
            }
...
test_attribute_exists(void)
{
    ...
    BEGIN_MULTIPART
    {
        ...
        {
            TESTING_2_API("H5Aexists_by_name");
            ...
            if ((attr_exists = H5Aexists_by_name(container_group, ATTRIBUTE_EXISTS_TEST_GROUP_NAME,
                ...
                PART_ERROR_API(H5Aexists_by_name);
            }
...
test_attribute_exists_invalid_params(void)
{
    ...
    BEGIN_MULTIPART
    {
        ...
        {
            TESTING_2_API("H5Aexists with an invalid loc_id");
            ...
            if (err_ret >= 0) {
                ...
                PART_ERROR_API(H5Aexists_invalid_loc_id);
            }
        ...
        {
            TESTING_2_API("H5Aexists with invalid attribute name");
            ...
            if (err_ret >= 0) {
                ...
                PART_ERROR_API(H5Aexists_invalid_attr_name);
            }
        ...
        {
            TESTING_2_API("H5Aexists_by_name with an invalid loc_id");
            ...
            if (err_ret >= 0) {
                ...
                PART_ERROR_API(H5Aexists_by_name_invalid_loc_id);
            }
        ...
        {
            TESTING_2_API("H5Aexists_by_name with invalid object name");
            ...
            if (err_ret >= 0) {
                ...
                PART_ERROR_API(H5Aexists_by_name_invalid_obj_name);
            }
        ...
        {
            TESTING_2_API("H5Aexists_by_name with invalid attribute name");
            ...
            if (err_ret >= 0) {
                ...
                PART_ERROR_API(H5Aexists_by_name_invalid_attr_name);
            }
        ...
        {
            TESTING_2_API("H5Aexists_by_name with an invalid link access property list");
...
test_attribute_many(void)
{
    ...
    TESTING_API("creating many attributes");
...
test_attribute_duplicate_id(void)
{
    ...
    TESTING_API("duplicated IDs for an attribute");
...
test_get_number_attributes(void)
{
    ...
    BEGIN_MULTIPART
    {
        ...
        {
            TESTING_2_API("H5Oget_info_by_name");
            ...
            if (H5Oget_info_by_name3(container_group, ATTRIBUTE_GET_NUM_ATTRS_TEST_GRP_NAME, &obj_info,
                ...
                PART_ERROR_API(H5Oget_info_by_name);
            }
        ...
        {
            TESTING_2_API("H5Oget_info_by_idx");
            ...
            if (H5Oget_info_by_idx3(container_group, ".", H5_INDEX_NAME, H5_ITER_INC, 0, &obj_info,
                ...
                PART_ERROR_API(H5Oget_info_by_idx);
            }
...
test_attr_shared_dtype(void)
{
    ...
    TESTING_API("shared datatype for attributes");
