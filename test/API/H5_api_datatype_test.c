...
test_create_committed_datatype(void)
{
    ...
    TESTING_API("creation of a committed datatype");
...
test_create_committed_datatype_invalid_params(void)
{
    ...
    BEGIN_MULTIPART
    {
        ...
        {
            TESTING_2_API("H5Tcommit2 with an invalid loc_id");
        ...
        {
            TESTING_2_API("H5Tcommit2 with an invalid datatype name");
            ...
            if (err_ret >= 0) {
                ...
                PART_ERROR_API(H5Tcommit2_invalid_type_name);
            }
        ...
        {
            TESTING_2_API("H5Tcommit2 with an invalid datatype ID");
        ...
        {
            TESTING_2_API("H5Tcommit2 with an invalid LCPL");
            ...
            if (err_ret >= 0) {
                ...
                PART_ERROR_API(H5Tcommit2_invalid_lcpl);
            }
        ...
        {
            TESTING_2_API("H5Tcommit2 with an invalid TCPL");
            ...
            if (err_ret >= 0) {
                ...
                PART_ERROR_API(H5Tcommit2_invalid_tcpl);
            }
        ...
        {
            TESTING_2_API("H5Tcommit2 with an invalid TAPL");
            ...
            if (err_ret >= 0) {
                ...
                PART_ERROR_API(H5Tcommit2_invalid_tapl);
            }
...
test_create_anonymous_committed_datatype(void)
{
    ...
    TESTING_API("creation of anonymous committed datatype");
...
test_create_anonymous_committed_datatype_invalid_params(void)
{
    ...
    BEGIN_MULTIPART
    {
        ...
        {
            TESTING_2_API("H5Tcommit_anon with an invalid loc_id");
        ...
        {
            TESTING_2_API("H5Tcommit_anon with an invalid datatype ID");
            ...
            if (err_ret >= 0) {
                ...
                PART_ERROR_API(H5Tcommit_anon_invalid_type_id);
            }
        ...
        {
            TESTING_2_API("H5Tcommit_anon with an invalid TCPL");
            ...
            if (err_ret >= 0) {
                ...
                PART_ERROR_API(H5Tcommit_anon_invalid_tcpl);
            }
        ...
        {
            TESTING_2_API("H5Tcommit_anon with an invalid TAPL");
            ...
            if (err_ret >= 0) {
                ...
                PART_ERROR_API(H5Tcommit_anon_invalid_tapl);
            }
...
test_create_committed_datatype_empty_types(void)
{
    ...
    BEGIN_MULTIPART
    {
        ...
        {
            TESTING_2_API("creation of committed datatype with empty compound type");

            if ((type_id = H5Tcreate(H5T_COMPOUND, (size_t)32)) < 0) {
                H5_FAILED_API();
                printf("    failed to create compound type\n");
                PART_ERROR_API(H5Tcommit_empty_compound_type);
            }
        ...
        PART_BEGIN(H5Tcommit_empty_enum_type)
        {
            ...
            TESTING_2_API("creation of committed datatype with empty enum type");

            if ((type_id = H5Tenum_create(H5T_NATIVE_INT)) < 0) {
                H5_FAILED_API();
                printf("    failed to create enum type\n");
                PART_ERROR_API(H5Tcommit_empty_enum_type);
            }
...
test_recommit_committed_type(void)
{
    ...
    TESTING_API("inability to re-commit a committed datatype");
...
test_open_committed_datatype_invalid_params(void)
{
    ...
    BEGIN_MULTIPART
    {
        ...
        {
            TESTING_2_API("H5Topen2 with an invalid location ID");
            ...
            if (type_id >= 0) {
                ...
                H5Tclose(type_id);
                PART_ERROR_API(H5Topen2_invalid_loc_id);
            }
        ...
        {
            TESTING_2_API("H5Topen2 with an invalid datatype name");
            ...
            if (type_id >= 0) {
                ...
                H5Tclose(type_id);
                PART_ERROR_API(H5Topen2_invalid_type_name);
            }
        ...
        {
            TESTING_2_API("H5Topen2 with an invalid TAPL");
            ...
            if (type_id >= 0) {
                ...
                H5Tclose(type_id);
                PART_ERROR_API(H5Topen2_invalid_tapl);
            }
...
test_reopen_committed_datatype_indirect(void)
{
    ...
    BEGIN_MULTIPART
    {
        ...
        {
            TESTING_2_API("re-open of compound datatype");

            if ((strtype = H5Tcopy(H5T_C_S1)) < 0) {
                H5_FAILED_API();
                printf("    failed to copy C-string datatype\n");
                PART_ERROR_API(reopen_compound_type);
            }
        ...
        PART_BEGIN(reopen_enum_type)
        {
            ...
            TESTING_2_API("re-open of enum datatype");

            if ((type_id = H5Tenum_create(H5T_NATIVE_INT)) < 0) {
                H5_FAILED_API();
                printf("    failed to create enum datatype\n");
                PART_ERROR_API(reopen_enum_type);
            }
        ...
        PART_BEGIN(reopen_opaque_type)
        {
            ...
            TESTING_2_API("reopen of an opaque datatype");
...
test_close_committed_datatype_invalid_id(void)
{
    ...
    TESTING_API("H5Tclose with an invalid committed datatype ID");
...
test_datatype_property_lists(void)
{
    ...
    BEGIN_MULTIPART
    {
        ...
        {
            TESTING_2_API("H5Tget_create_plist");
            ...
            if ((tcpl_id1 = H5Tget_create_plist(type_id1)) < 0) {
                ...
                PART_ERROR_API(H5Tget_create_plist);
            }
...
test_create_dataset_with_committed_type(void)
{
    ...
    TESTING_API("dataset creation with a committed datatype");
...
test_create_attribute_with_committed_type(void)
{
    ...
    TESTING_API("attribute creation with a committed datatype");
...
test_delete_committed_type(void)
{
    ...
    TESTING_API("committed datatype deletion");
...
test_resurrect_datatype(void)
{
    ...
    TESTING_API("resurrecting datatype after deletion");
...
{
    TESTING_API("H5Tflush with invalid parameters");
...
{
    TESTING_API("H5Trefresh with invalid parameters");
...
test_cant_commit_predefined(void)
{
    ...
    TESTING_API("inability to commit predefined types directly");
...
test_cant_modify_committed_type(void)
{
    ...
    TESTING_API("inability to modify a committed datatype");
