...
test_create_file_invalid_params(TestParams_t *params)
{
    ...
    BEGIN_MULTIPART
    {
        ...
        {
            TESTFRAME_TESTING_2(params, "H5Fcreate with invalid file name");
        ...
        {
            TESTFRAME_TESTING_2(params, "H5Fcreate with invalid flags");
        ...
        {
            TESTFRAME_TESTING_2(params, "H5Fcreate with invalid FCPL");
...
test_open_file_invalid_params(TestParams_t *params)
{
    ...
    BEGIN_MULTIPART
    {
        ...
        {
            TESTFRAME_TESTING_2(params, "H5Fopen with invalid file name");
        ...
        {
            TESTFRAME_TESTING_2(params, "H5Fopen with invalid flags");
...
test_file_permission(TestParams_t *params)
{
    ...
    BEGIN_MULTIPART
    {
        ...
        {
            TESTFRAME_TESTING_2(params, "invalid creation of group in read-only file");
        ...
        {
            TESTFRAME_TESTING_2(params, "invalid creation of dataset in read-only file");
        ...
        {
            TESTFRAME_TESTING_2(params, "invalid creation of attribute in read-only file");
        ...
        {
            TESTFRAME_TESTING_2(params, "invalid creation of committed datatype in read-only file");
 ...
 * invalid file ID */
static herr_t
test_close_file_invalid_id(TestParams_t *params)
{
    herr_t err_ret = -1;
...
test_flush_file(TestParams_t *params)
{
    ...
    BEGIN_MULTIPART
    {
        ...
        {
            TESTFRAME_TESTING_2(params, "file flushing at local scope");
        ...
        {
            TESTFRAME_TESTING_2(params, "file flushing at global scope");
...
test_file_is_accessible(TestParams_t *params)
{
    ...
    BEGIN_MULTIPART
    {
        ...
        {
            TESTFRAME_TESTING_2(params, "H5Fis_accessible on existing file");
        ...
        {
            TESTFRAME_TESTING_2(params, "H5Fis_accessible on non-existing file");
...
test_file_property_lists(TestParams_t *params)
{
    ...
    BEGIN_MULTIPART
    {
        ...
        {
            TESTFRAME_TESTING_2(params, "H5Fget_create_plist");
        ...
        {
            TESTFRAME_TESTING_2(params, "H5Fget_access_plist");
        ...
        {
            TESTFRAME_TESTING_2(params, "H5Fget_create_plist after re-opening file");
...
test_get_file_intent(TestParams_t *params)
{
    ...
    BEGIN_MULTIPART
    {
        ...
        {
            TESTFRAME_TESTING_2(params, "H5Fget_intent on newly-created file");
        ...
        {
            TESTFRAME_TESTING_2(params, "H5Fget_intent for file opened read-only");
        ...
        {
            TESTFRAME_TESTING_2(params, "H5Fget_intent for file opened read-write");
...
test_get_file_obj_count(TestParams_t *params)
{
    ...
    BEGIN_MULTIPART
    {
        ...
        {
            TESTFRAME_TESTING_2(params, "H5Fget_obj_count for files");
        ...
        {
            TESTFRAME_TESTING_2(params, "H5Fget_obj_count for groups in single file");
        ...
        {
            TESTFRAME_TESTING_2(params, "H5Fget_obj_count for groups");
        ...
        {
            TESTFRAME_TESTING_2(params, "H5Fget_obj_count for datatypes");
        ...
        {
            TESTFRAME_TESTING_2(params, "H5Fget_obj_count for attributes");
        ...
        {
            TESTFRAME_TESTING_2(params, "H5Fget_obj_count for datasets");
        ...
        {
            TESTFRAME_TESTING_2(params, "H5Fget_obj_count for all object types in single file");
        ...
        {
            TESTFRAME_TESTING_2(params, "H5Fget_obj_count for all object types");
        ...
        {
            TESTFRAME_TESTING_2(params, "H5Fget_obj_ids for a singular group");
...
test_get_file_name(TestParams_t *params)
{
    ...
    BEGIN_MULTIPART
    {
        ...
        {
            TESTFRAME_TESTING_2(params, "H5Fget_name using file ID");
        ...
        {
            TESTFRAME_TESTING_2(params, "H5Fget_name using non-root group ID");
        ...
        {
            TESTFRAME_TESTING_2(params, "H5Fget_name using dataset ID");
        ...
        {
            TESTFRAME_TESTING_2(params, "H5Fget_name using attribute ID");
        ...
        {
            TESTFRAME_TESTING_2(params, "H5Fget_name using committed datatype ID");
        ...
        PART_BEGIN(H5Fget_name_dspace_id)
        {
            ...
            TESTFRAME_TESTING_2(params, "invalid H5Fget_name using dataspace ID");
