...
test_open_link_without_leading_slash(void)
{
    ...
    TESTING_API("opening a link without a leading slash");
...
test_object_creation_by_absolute_path(void)
{
    ...
    BEGIN_MULTIPART
    {
        ...
        {
            TESTING_2_API("creation of group using absolute pathname");
        ...
        {
            TESTING_2_API("creation of dataset using absolute pathname");
            ...
            if ((fspace_id = generate_random_dataspace(OBJECT_CREATE_BY_ABSOLUTE_PATH_TEST_DSET_SPACE_RANK,
                ...
                PART_ERROR_API(H5Dcreate_using_absolute_path);
            }
        ...
        {
            TESTING_2_API("creation of committed datatype using absolute pathname");
            ...
            if ((dtype_id = generate_random_datatype(H5T_NO_CLASS, FALSE)) < 0) {
                ...
                PART_ERROR_API(H5Tcommit_using_absolute_path);
            }
...
test_absolute_vs_relative_path(void)
{
    ...
    BEGIN_MULTIPART
    {
        ...
        {
            TESTING_2_API("dataset creation by absolute path from root group");
        ...
        {
            TESTING_2_API("dataset creation by absolute path from non-root group");
            ...
            if ((dset_id4 = H5Dcreate2(container_group,
                ...
                PART_ERROR_API(H5Dcreate_absolute_from_nonroot);
            }
        ...
        {
            TESTING_2_API("dataset creation by relative path from root group");
        ...
        {
            TESTING_2_API("dataset creation by relative path from non-root group");
        ...
        {
            TESTING_2_API("dataset creation by path with leading '.' from root group");
        ...
        {
            TESTING_2_API("dataset creation by path with leading '.' from non-root group");
            ...
            if ((dset_id6 = H5Dcreate2(group_id, "./" ABSOLUTE_VS_RELATIVE_PATH_TEST_DSET6_NAME, dset_dtype6,
                ...
                PART_ERROR_API(H5Dcreate_relative_leading_dot_nonroot);
            }
...
test_dot_for_object_name(void)
{
    ...
    BEGIN_MULTIPART
    {
        ...
        {
            TESTING_2_API("invalid creation of group with '.' as name");
            ...
            if (group_id >= 0) {
                ...
                PART_ERROR_API(H5Gcreate_dot_as_name);
            }
        ...
        {
            TESTING_2_API("invalid creation of dataset with '.' as name");
            ...
            if (dset_id >= 0) {
                ...
                PART_ERROR_API(H5Dcreate_dot_as_name);
            }
        ...
        {
            TESTING_2_API("invalid creation of committed datatype with '.' as name");

            if ((dtype_id = H5Tcopy(H5T_NATIVE_INT)) < 0) {
                H5_FAILED_API();
                printf("    couldn't copy a native datatype\n");
                PART_ERROR_API(H5Tcommit_dot_as_name);
            }
...
{
    TESTING_API("double init/term correctness");
...
test_symbols_in_compound_field_name(void)
{
    ...
    TESTING_API("usage of '{', '}' and '\\\"' symbols in compound field name");
